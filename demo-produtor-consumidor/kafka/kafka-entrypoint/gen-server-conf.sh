...
replica.socket.timeout.ms=600000
...
socket.connection.setup.timeout.max.ms=600000
...
# Grant rights to server certificate 
super.users=SPIFFE:spiffe://lsd.ufcg.edu.br/kafka
...
advertised.listeners=SSL://kafka:9092

# PEM certificates
ssl.truststore.type=PEM
ssl.keystore.type=PEM
security.protocol=SSL
ssl.keystore.location=/store/kafka-server-pair.pem
ssl.key.password=123456
ssl.truststore.location=/store/ca-cert.pem
...
socket.request.max.bytes=52423300
...
log.retention.milliseconds=3000
